      ...
      <div class="wrap__row wrap__row--height-full">
        <div class="container">
          ...
          <div class="contents bi-logo-type">
            ...
            <div class="link-tab">
              <div class="inner">
                <div class="display-table col04">
                  ...
                  <a href="/about/about_0902" class="current">Core Value</a>
            ...
            <!-- //link-tab -->
            <div class="inner">
              <div class="brandCoreValue">
              	<h5>Brand Core Value</h5>
              	<img src="/resources/images/about/img_about_0901_value.png" alt="현대아산">
              </div>
            </div>
