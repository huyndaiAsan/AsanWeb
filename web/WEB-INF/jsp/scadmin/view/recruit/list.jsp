          ...
          <div class="col-sm-12">
            <table class="table table-striped table-bordered">
              <thead>
                ...
                <th class="text-center" style="width:200px;">접수기간</th>
          ...
          <div class="col-xs-12">
            <div class="text-center">
              <ul class="pagination">
			    ...
			    <form action="/admin/board/${category}/list" class="_bbsForm" method="post">
