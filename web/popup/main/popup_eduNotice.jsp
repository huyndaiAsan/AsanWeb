...
<div class="popup">
	<div class="image"><img src="/resources/images/pyrolysis_popup.jpg" id="test" alt=""></div>
	<div style="background-color:#000000; /* width:450px; */ height:30px; text-align:center; margin-top: -5px;">
		<form name="pop">
