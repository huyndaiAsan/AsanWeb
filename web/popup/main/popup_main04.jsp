...
<div class="popup">
	<!-- <div class="image"><img src="/resources/images/fib_apt_meeting_popup.jpg" id="test" alt=""></div> -->
	<div class="image">
		<a href="https://aac.kist.re.kr/news/notice/view?boardId=100874" target="_blank">
			<img src="/resources/images/main/popup/popup_20170717.jpg" id="test" alt="">
		</a>
	</div>
